...
# ---- stats lane moved out of diagnostics ----

@test "diagnostics no longer posts to /api/feeders/reception" {
    # The feeder-attested stats lane moved to airplanes-stats.sh (its own
